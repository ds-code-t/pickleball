...
| `pkb_features` | `classpath:features` | regular scenario feature-file location |
| `pkb_componentpath` | `src/test/resources/component` | reusable component-scenario feature location |
| `pkb_callpath` | `src/test/resources/calls` | reusable service-call feature location |
