...
- [Pickleball Studio](pickleball-studio.md) — isolated Studio application, Swing workspace/editor UI, workspace/process services, Maven and Gradle build execution, Gradle Tooling API project/navigation models, Java/Gherkin source navigation, managed runs, and Streamable-HTTP MCP.
