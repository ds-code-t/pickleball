...
- [Pickleball Studio](pickleball-studio.md) — isolated Studio application, workspace/process services, self-contained Maven and Gradle Wrapper build execution, managed runs, and the Streamable-HTTP MCP foundation.
