...
- [Pickleball Studio](pickleball-studio.md) — isolated Studio application, workspace/process services, self-contained Maven and Gradle Wrapper build execution, Gradle Tooling API project/navigation models, managed runs, and the Streamable-HTTP MCP foundation.
