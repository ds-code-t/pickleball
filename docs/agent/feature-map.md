...
| Component scenarios | `src/main/java/tools/dscode/coredefinitions/ModularScenarios.java`; `src/main/java/io/cucumber/core/runner/modularexecutions/CucumberScanUtil.java`; search scenario registration, option filtering, ordering, limit, and argument mapping | `src/test/java/tools/dscode/coredefinitions/ModularScenariosTest.java` | `component-scenarios.feature`; `reusable-scenario-selection.feature`; `calls/service-call-definitions.feature`; `site/components.html` | `docs/component-scenarios.md` |
| Service-call definitions and execution | `src/main/java/tools/dscode/coredefinitions/ServiceCallSteps.java`; `src/main/java/tools/dscode/coredefinitions/ModularScenarios.java`; `src/main/java/tools/dscode/common/servicecalls/RestAssuredUtil.java`; mapping classes under `common/mappings`; search request/response, scenario selection, and SOAP handling | `src/test/java/tools/dscode/coredefinitions/ModularScenariosTest.java`; search `src/test` for service, request, response, JSON, and XML tests | `service-call-execution.feature`; `reusable-scenario-selection.feature`; `calls/service-call-definitions.feature`; local server support under `maven-consumer-project/src/test/java`; resources under `site` | `docs/service-call-scenarios.md`; `docs/mapping-and-templating.md` |
| Date/time utilities | `src/main/java/tools/dscode/coredefinitions/DateTimeUtilitySteps.java`; `src/main/java/tools/dscode/common/util/datetime` | Search `src/test` for date/time tests | `date-time-utilities.feature`; `site/datetime.html` | `docs/date-time-utilities.md` |
