...
| Component scenarios | `src/main/java/tools/dscode/coredefinitions/ModularScenarios.java`; search `Component`, scenario registration/execution, and argument mapping | Search `src/test` for component-scenario tests | `component-scenarios.feature`; `calls/service-call-definitions.feature`; `site/components.html` | `docs/component-scenarios.md` |
| Service-call definitions and execution | `src/main/java/tools/dscode/coredefinitions/ServiceCallSteps.java`; `src/main/java/tools/dscode/common/servicecalls/RestAssuredUtil.java`; mapping classes under `common/mappings`; search request/response and SOAP handling | Search `src/test` for service, request, response, JSON, and XML tests | `service-call-execution.feature`; `calls/service-call-definitions.feature`; local server support under `maven-consumer-project/src/test/java`; resources under `site` | `docs/service-call-scenarios.md`; `docs/mapping-and-templating.md` |
