...
package tools.ds.modkit.contrib.cucumber;
...
import static tools.ds.modkit.blackbox.CtorRegistryDSL.globalRegisterConstructed;
import static tools.ds.modkit.blackbox.CtorRegistryDSL.threadRegisterConstructed;
import static tools.ds.modkit.blackbox.Registry.register;
...
public final class CucumberModKitBootstrap {
    ...
    public static final java.util.UUID SKIP_LOGGING = new java.util.UUID(0L, 0xFFL);
