package tools.dscode.modkit.util.stepbuilder;
...
public class StepUtilities {
    ...
    public static PickleStep createPickleStep(PickleStepArgument pickleStepArgument, List<String> astNodeIds, String id, PickleStepType pickleStepType, String stepText) {
    ...
    public static Step createGherikinMessageStep(PickleStep pickleStep, String previousGivenWhenThenKeyword, Location location, String keyword) {
    ...
    public static PickleStepTestStep createPickleStepTestStep(PickleStepArgument pickleStepArgument, List<String> astNodeIds, String id, PickleStepType pickleStepType, String stepText, String previousGivenWhenThenKeyword, Location location, String keyword, UUID uuid, URI uri) {
    ...
    public static PickleStepTestStep createScenarioPickleStepTestStep(Pickle pickle, PickleStepTestStep pickleStepTestStep) {
        try {
