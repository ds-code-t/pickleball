...
public class FeatureFileUtilitiesTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            int lineNumber = 50;
//            Object obj = FeatureFileUtilities.getScenarioByLine(featureUri, lineNumber);
//            System.out.println("@@@@1 ");
//
//            System.out.println("Object at line1 " + lineNumber + ": " + obj.getClass() + "  : " + obj  );

//            lineNumber = 59;
//
//            Object obj2 = FeatureFileUtilities.getScenarioByLine(featureUri, lineNumber);
//            System.out.println("@@@@1 ");
//
//            System.out.println("Object at line2 " + lineNumber + ": " + obj2.getClass() + "  : " + obj2  );
            ...
            feature.getChildren().forEach(c -> System.out.println("@@@child:: " + c.toString() + " " + c.getName() + "  , " + c.getClass()));
