...
public class UniversalWebDriver extends RemoteWebDriver implements Registerable {
    ...
    public static UniversalWebDriver createUniversalWebDriver(Object... args) {
        ...
        return switch (args[0].getClass().getSimpleName()) {
            case "ChromeDriverService" -> switch (args.length) {
                ...
                case 3 -> createChromeDriver((ChromeDriverService) args[0], (ChromeOptions) args[1], (ClientConfig) args[2]);
            ...
            case "FirefoxDriverService" -> switch (args.length) {
                ...
                case 3 -> createFirefoxDriver((FirefoxDriverService) args[0], (FirefoxOptions) args[1], (ClientConfig) args[2]);
    ...
    public void setFileDetector(FileDetector detector) {
          invokeMethod("setFileDetector", new Class<?>[]{FileDetector.class});
//        internalDriver.setFileDetector(detector);
    }
