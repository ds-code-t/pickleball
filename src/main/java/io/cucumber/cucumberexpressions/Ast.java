...
//                case (int) '/':  // Alternation
//                case (int) '{':  // Begin parameter
//                case (int) '}':  // End parameter
//                case (int) '(':  // Begin optional
//                case (int) ')':  // End optional
//                case (int) '.':  // Regex any character
//                case (int) '*':  // Regex zero or more repetitions
//                case (int) '+':  // Regex one or more repetitions
//                case (int) '?':  // Regex zero or one repetitions
//                case (int) '|':  // Regex alternation
//                case (int) '[':  // Regex character class begin
//                case (int) ']':  // Regex character class end
//                case (int) '^':  // Regex start of string
//                case (int) '$':  // Regex end of string
//                case (int) '=':  // Regex assertions
//                case (int) '!':  // Regex negations
//                case (int) '-':  // Regex ranges
//                    return true;
