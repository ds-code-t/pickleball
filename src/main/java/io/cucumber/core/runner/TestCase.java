...
//        super(id, (StepDefinitionMatch) stepDefinition);
        this.id = id;
    ...
    void run(EventBus bus) {
        ...
        System.out.println("@@primaryScenario: " + scenarioContext.getId());
//        setPrimaryScenario(scenarioContext);
        runComponent(bus);
    }

    void runComponent(EventBus bus) {
        System.out.println("@@getName()==:  " + getName());
        System.out.println("@@getScenarioLocation:  " + pickle.getScenarioLocation());
        System.out.println("@@getUri:  " + getUri());
        System.out.println("@@getId:  " + getId());
        System.out.println("@@getLocation: " + getLocation().getLine() +":" + getLocation().getColumn());
        System.out.println("@@pickle.getClass(): " + pickle.getClass());
        System.out.println("@@pickle.getExamplesLocation(): " + pickle.getExamplesLocation());
