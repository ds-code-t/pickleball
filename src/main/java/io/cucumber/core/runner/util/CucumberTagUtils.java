...
public final class CucumberTagUtils {
    ...
    /**
     * Return tag expressions (as strings) from either RuntimeOptions or
    ...
    public static List<String> extractTags(Object runnerOptions) {
        ...
        // 1) RuntimeOptions#getTagExpressions():
        // List<io.cucumber.tagexpressions.Expression>
        ...
        // 3) CucumberConfiguration has a ConfigurationParameters field; read
        ...
        // 4) Last ditch: look for a generic "getFilters"/"getTags"/"tags"
        // pattern
    ...
    private static Object unwrapOptional(Object maybeOpt) {
        ...
        try {
            ...
            if (!"java.util.Optional".equals(c.getName()))
                return null;
