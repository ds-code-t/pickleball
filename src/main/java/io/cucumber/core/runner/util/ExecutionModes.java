// src/main/java/tools/ds/util/ExecutionModes.java
...
public final class ExecutionModes {
    ...
    public static Object RUN(Object anchor) {
        return constant(loaderFor(anchor), "RUN");
    }

    public static Object DRY_RUN(Object anchor) {
        return constant(loaderFor(anchor), "DRY_RUN");
    }

    public static Object SKIP(Object anchor) {
        return constant(loaderFor(anchor), "SKIP");
    }

    // Convenience when you don’t have a good anchor (uses TCCL, then our
    // loader)
    public static Object RUN() {
        return constant(loaderFor(null), "RUN");
    }

    public static Object DRY_RUN() {
        return constant(loaderFor(null), "DRY_RUN");
    }

    public static Object SKIP() {
        return constant(loaderFor(null), "SKIP");
    }
    ...
    public static boolean isRun(Object mode) {
        return is(mode, "RUN");
    }

    public static boolean isDryRun(Object mode) {
        return is(mode, "DRY_RUN");
    }

    public static boolean isSkip(Object mode) {
        return is(mode, "SKIP");
    }
