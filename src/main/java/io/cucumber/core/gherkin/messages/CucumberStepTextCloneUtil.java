...
final class CucumberStepTextCloneUtil {

    private static final Unsafe UNSAFE = initUnsafe();

    private CucumberStepTextCloneUtil() {
    }

    static PickleStep deepClonePickleStepWithText(PickleStep source, String newText) {
        if (source == null) {
            return null;
        }
    ...
    static GherkinMessagesStep deepCloneGherkinMessagesStepWithText(GherkinMessagesStep source, String newText) {
        ...
        setField(clone, "pickleStep", deepClonePickleStepWithText(getField(source, "pickleStep"), newText));
