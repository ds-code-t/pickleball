...
public class Main {
    public static void main(String[] args) {
        // Test 1: default delimiters (',', ';', ':', '.') with quotes + nested brackets
        String input1 = """
        ...
        // Test 2: custom delimiters (only '|'), verify others are ignored for splitting
        String input2 = """
    ...
    private static void runDemo(String title, Sentence sentence) {
        ...
        System.out.println(sentence.quoteParser().masked());
