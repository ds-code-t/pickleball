...
//            return getRunningStep().getDataTable();
//        } else {
//            return  (DataTable) getCurrentScenarioState().get("-" + TABLE_KEY + "_" + tableName);
//        }
//    }
...
//        ParsingMap parsingMap = currentScenarioState.getParsingMap();
