package tools.dscode.modkit.executions;
...
import tools.dscode.modkit.state.ScenarioState;
import tools.dscode.modkit.trace.ObjDataRegistry;
...
import static tools.dscode.modkit.mappings.MapConfigurations.DataSource.EXAMPLE_TABLE;
import static tools.dscode.modkit.state.ScenarioState.getScenarioState;
import static tools.dscode.modkit.trace.ObjDataRegistry.setFlag;
...
public class StepExecution {
    ...
    public StepExecution(TestCase testCase) {
        ...
        rootScenarioNameStep.overRideUUID = SKIP_LOGGING;
