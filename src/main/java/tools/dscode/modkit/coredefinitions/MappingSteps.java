...
import static tools.dscode.modkit.extensions.StepExtension.getCurrentStep;
...
import static tools.dscode.modkit.util.TableUtils.toFlatMultimap;
import static tools.dscode.modkit.util.TableUtils.toRowsMultimap;
...
//            currentStep.getStepNodeMap().merge(rowMap);
        ...
        System.out.println("@currentStepgetStepParsingMap get(\"ROWS\") " + currentStep.getStepParsingMap().get("ROWS"));
