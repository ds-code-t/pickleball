...
//    }
//
//    public static CheckResult isTruthy(List<ValueWrapper> input) {
//        boolean ok = input.stream().anyMatch(ValueWrapper::isTruthy);
//        String desc = ok
...
//    }
//
//    public static CheckResult hasValue(List<ValueWrapper> values, ValueWrapper comparisonVal, boolean anyTrue) {
//        String comparisonString = comparisonVal.toString();
//        boolean ok = anyTrue ? values.stream().anyMatch(c -> (c.toNonNullString().equals(comparisonVal.toNonNullString()))) : values.stream().allMatch(c -> c.toNonNullString().equals(comparisonVal.toNonNullString()));
//        boolean ok = anyTrue ? values.stream().anyMatch(c -> !(c.toNonNullString().isBlank())) : values.stream().noneMatch(c -> c.toNonNullString().isBlank());
//        String desc = ok
...
//    }
//
//    public static CheckResult isBlank(List<ValueWrapper> values, boolean anyTrue) {
//        boolean ok = anyTrue ? values.stream().anyMatch(c -> (c.toNonNullString().isBlank())) : values.stream().allMatch(c -> c.toNonNullString().isBlank());
