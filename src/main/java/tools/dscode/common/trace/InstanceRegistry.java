package tools.dscode.common.trace;// package tools.dscode.common.trace;
//
// import tools.dscode.common.state.GlobalState;
// import tools.dscode.common.state.ScenarioState;
//
...
// return ScenarioState.getScenarioState(); // may be null if
// // beginNew()/set() wasn't
// // called
// }
//
...
//
// /**
// * Register value under each key in the current thread’s ScenarioState
// * (no-op if none).
// */
...
//
// if (s != null)
// s.register(value, keys);
// }
//
// /**
// * Get untyped value from the current thread’s ScenarioState (null if none
// * or missing).
// */
