 ...
 * Masking order for split-protection: 1) QuoteParser (', ", `, and any extras
 * you added, e.g., ''') 2) BracketMasker ((), {}, [], &lt;>) Unmasking is
 * performed in the reverse order per-phrase: 1) BracketMasker.restoreFrom(...)
 * 2) QuoteParser.restoreFrom(...) Default delimiters: ',', ';', ':', '.' You
 * can supply a custom set via the (String, Collection&lt;Character>)
 * constructor.
 */
