...
| Consumer dependency guidance export and `.pickleball` lifecycle | `src/main/java/tools/dscode/common/reporting/diagnostic/DiagnosticCli.java`; `scripts/sync_consumer_guidance.py`; search `export-guidance`, `GUIDANCE-MANIFEST.json`, `.pickleball`, `ensureGuidanceIgnored` | Consumer-hosted `PickleballGuidanceChecks.java` | `maven-consumer-project/AGENTS.md`; `maven-consumer-project/.gitignore`; `maven-consumer-project/README.md` | `docs/consumer-agent-guide.md`; `docs/consumer-project.md`; `docs/agent/README.md` |
