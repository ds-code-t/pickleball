...
//            getRunningStep().stepEntry.level(Level.ERROR).status(Status.UNKNOWN);
//        }
//
//        @Given("^EntryTest9(?: (.*))?$")
//        public static void entryTest9(String value) {
//            getRunningStep().stepEntry.level(Level.WARN).status(Status.SKIP);
//        }
//
//        @Given("^EntryTest10(?: (.*))?$")
...
//        entry.info("child2").status(Status.PASS).timestamp().info("gradnchaild2").screenshot("Test").status(Status.FAIL).timestamp();
//        entry.info("child3").status(Status.PASS).timestamp().info("gradnchaild3").screenshot().status(Status.PASS).timestamp();
...
//                .info("zchild2").status(Status.PASS).timestamp().info("zgzradnchaild2").status(Status.FAIL).timestamp()
//                .info("zchild3").status(Status.PASS).timestamp().info("zgradnchaild3").status(Status.PASS).timestamp()
...
//                        "        .logInfo(\"zchild3\").status(Status.PASS).timestamp().logInfo(\"zgradnchaild3\").status(Status.PASS).timestam").status(Status.SKIP).timestamp();
//
//    }
//
//    @Given("config")
