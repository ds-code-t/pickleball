...
//import static io.cucumber.core.runner.ScenarioState.getTestCase;
//import static io.cucumber.core.runner.ScenarioState.getTestCaseState;
//import static io.cucumber.core.runner.ScenarioState.setKeyedTemplate;
//import static io.cucumber.core.runner.util.cucumberutils.StepBuilder.createMessageStep;
//import static io.cucumber.core.runner.util.cucumberutils.StepBuilder.createStepExtension;
//
///**
...
//    public Step gherikinMessageStep;
//
...
//        }
//
//        this.gherikinMessageStep =  delegate.getStep();
//        this.rootStep = (PickleStep) getProperty(gherikinMessageStep, "step");
//
