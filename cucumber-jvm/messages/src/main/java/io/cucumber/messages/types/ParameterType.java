...
/**
 * Represents the ParameterType message in <a
...
public final class ParameterType {
    ...
    public ParameterType(
        ...
        this.regularExpressions = unmodifiableList(
            new ArrayList<>(requireNonNull(regularExpressions, "ParameterType.regularExpressions cannot be null")));
        this.preferForRegularExpressionMatch = requireNonNull(preferForRegularExpressionMatch,
            "ParameterType.preferForRegularExpressionMatch cannot be null");
