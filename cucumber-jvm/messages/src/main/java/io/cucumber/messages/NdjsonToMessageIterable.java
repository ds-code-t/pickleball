...
/**
 * Iterates over messages read from a stream. Client code should not depend on
 * this class directly, but rather on a {@code Iterable<Envelope>} object. Tests
 * can then use a {@code new ArrayList<Envelope>} which implements the same
 * interface.
 */
