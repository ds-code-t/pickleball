...
/**
 * Represents the TestStepResult message in <a
...
public final class TestStepResult {
    ...
    /**
     * An arbitrary bit of information that explains this result. If there was
     * an exception, this should include a stringified representation of it
     * including type, message and stack trace (the exact format will vary by
     * platform).
     */
