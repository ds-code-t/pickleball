...
/**
 * Represents the Step message in <a
...
public final class Step {
    ...
    /**
     * The test phase signalled by the keyword: Context definition (Given),
     * Action performance (When), Outcome assertion (Then). Other keywords
     * signal Continuation (And and But) from a prior keyword. Please note that
     * all translations which a dialect maps to multiple keywords (`*` is in
     * this category for all dialects), map to 'Unknown'.
     */
