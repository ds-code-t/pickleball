...
/**
 * Represents the Feature message in <a
...
public final class Feature {
    ...
    /**
     * The [ISO 639-1](https://en.wikipedia.org/wiki/ISO_639-1) language code of
     * the Gherkin document
     */
    ...
    /**
     * The text of the `Feature` keyword (in the language specified by
     * `language`)
     */
    ...
    /**
     * The line(s) underneath the line with the `keyword` that are used as
     * description
     */
