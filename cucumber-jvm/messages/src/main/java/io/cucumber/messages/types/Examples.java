...
import static tools.dscode.common.GlobalConstants.COMPONENT_TAGS;
import static tools.dscode.common.GlobalConstants.SCENARIO_TAGS;

/**
 * Represents the Examples message in <a
...
public final class Examples {
    ...
    public final int componentTagsIndex;
    ...
    public Examples(
        ...
        System.out.println("@@@examples!!! " + tableBody);
        ...
        this.tableBody = unmodifiableList(
            new ArrayList<>(requireNonNull(tableBody, "Examples.tableBody cannot be null")));
        ...
        this.scenarioTagsIndex = IntStream.range(0, tableHeader.getCells().size())
                ...
                .findFirst()
                .orElse(-1);
        this.componentTagsIndex = IntStream.range(0, tableHeader.getCells().size())
                .filter(i -> tableHeader.getCells().get(i).getValue().trim().equals(COMPONENT_TAGS))
                .findFirst()
                .orElse(-1);
    }
