...
/**
 * Represents the StepMatchArgumentsList message in <a
...
public final class StepMatchArgumentsList {
    ...
    public StepMatchArgumentsList(
        ...
        this.stepMatchArguments = unmodifiableList(new ArrayList<>(
            requireNonNull(stepMatchArguments, "StepMatchArgumentsList.stepMatchArguments cannot be null")));
    }
    ...
    public boolean equals(Object o) {
        ...
        return stepMatchArguments.equals(that.stepMatchArguments);
    }
