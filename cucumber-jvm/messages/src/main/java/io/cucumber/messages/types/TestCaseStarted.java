...
/**
 * Represents the TestCaseStarted message in <a
...
public final class TestCaseStarted {
    ...
    /**
     * Because a `TestCase` can be run multiple times (in case of a retry), we
     * use this field to group messages relating to the same attempt.
     */
    public String getId() {
        return id;
    }
     ...
     * worker, but no particular format is defined - it could be an index, uuid,
     * machine name etc - and as such should be assumed that it's not human
     * readable.
     */
    ...
    public boolean equals(Object o) {
        ...
        return attempt.equals(that.attempt) &&
                id.equals(that.id) &&
