...
/**
 * Represents the JavaMethod message in <a
...
public final class JavaMethod {
    ...
    public JavaMethod(
        ...
        this.methodParameterTypes = unmodifiableList(
            new ArrayList<>(requireNonNull(methodParameterTypes, "JavaMethod.methodParameterTypes cannot be null")));
    }
