...
/**
 * Represents the TestRunHookFinished message in <a
...
public final class TestRunHookFinished {
    ...
    public TestRunHookFinished(
        ...
        this.testRunHookStartedId = requireNonNull(testRunHookStartedId,
            "TestRunHookFinished.testRunHookStartedId cannot be null");
    ...
    public boolean equals(Object o) {
        ...
        return testRunHookStartedId.equals(that.testRunHookStartedId) &&
