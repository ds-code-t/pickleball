...
/**
 * Represents the TestRunFinished message in <a
...
public final class TestRunFinished {
    ...
    /**
     * An informative message about the test run. Typically additional
     * information about failure, but not necessarily.
     */
    ...
    /**
     * A test run is successful if all steps are either passed or skipped, all
     * before/after hooks passed and no other exceptions where thrown.
     */
    ...
    /**
     * Any exception thrown during the test run, if any. Does not include
     * exceptions thrown while executing steps.
     */
