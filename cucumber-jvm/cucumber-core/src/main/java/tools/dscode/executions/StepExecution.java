package tools.dscode.executions;
...
import static tools.dscode.common.mappings.MapConfigurations.DataSource.EXAMPLE_TABLE;
...
public class StepExecution {
    ...
    public static void setNesting(
            List<StepExtension> steps, int startingNesting, Map<Integer, StepExtension> nestingMap
    ) {
        int size = steps.size();
    ...
    public void runSteps(Object executionMode) {
        runSteps(getScenarioState().testCase, getScenarioState().bus, getScenarioState().getTestCaseState(),
            executionMode);
    }
