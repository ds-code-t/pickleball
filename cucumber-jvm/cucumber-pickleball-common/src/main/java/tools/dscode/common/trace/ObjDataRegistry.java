package tools.dscode.common.trace;
...
public final class ObjDataRegistry {
    ...
    public enum ObjFlags {
        NOT_SET, INITIALIZING, RUNNING, COMPLETE, LAST
    }
    ...
    private static final Map<Object, Map<Object, Object>> DATA = Collections.synchronizedMap(new WeakHashMap<>());
    ...
    public static void set(Object owner, Object key, Object value) {
        if (owner == null)
            throw new IllegalArgumentException("set: owner must not be null");
        if (key == null)
            throw new IllegalArgumentException("set: key must not be null");
    ...
    public static Object get(Object owner, Object key) {
        if (owner == null)
            throw new IllegalArgumentException("get: owner must not be null");
        if (key == null)
            throw new IllegalArgumentException("get: key must not be null");
    ...
    public static void setFlag(Object owner, ObjFlags... flags) {
        if (owner == null)
            throw new IllegalArgumentException("setFlag: owner must not be null");
    ...
    public static ObjFlags getFlag(Object owner) {
        if (owner == null)
            throw new IllegalArgumentException("getFlag: owner must not be null");
        Map<Object, Object> m = bucketIfPresent(owner);
        if (m == null)
            return ObjFlags.NOT_SET;
        @SuppressWarnings("unchecked")
    ...
    public static boolean containsFlags(Object owner, ObjFlags... flags) {
        if (owner == null)
            throw new IllegalArgumentException("containsFlags: owner must not be null");
        if (flags == null || flags.length == 0)
    ...
    public static void clearFlags(Object owner) {
        if (owner == null)
            throw new IllegalArgumentException("clearFlags: owner must not be null");
        Map<Object, Object> m = bucketIfPresent(owner);
        if (m != null)
            m.remove(FLAGS_KEY);
    }
