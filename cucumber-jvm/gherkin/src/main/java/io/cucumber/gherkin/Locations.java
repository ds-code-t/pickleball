...
final class Locations {
    ...
    /**
     * Cache of Long objects for the range 0-4095. This is used to avoid
     * creating a huge amount of Long objects in getLocation(). We can't use
     * Long.valueOf() because it caches only the first 128 values, and typical
     * feature files have much more lines.
     */
    ...
    static Location atLine(int line) {
        // By design, the column cannot be less than 1 (it comes from
        // TokenScanner)
