...
final class StringUtils {
    ...
    static boolean isWhitespace(char c) {
        ...
        // Category 2: Latin block to Unified Canadian Aboriginal Syllabics
        // block
        ...
        return (c == ' ' || c == '\t')
                ...
                // Test only two remaining whitespace characters in the range
                // (32, 5760).
                || (c == '\u0085' || c == '\u00a0');
    }
    ...
    private static boolean isDirectionalitySpace(char c) {
        return ((((1 << Character.DIRECTIONALITY_WHITESPACE)
                | (1 << Character.DIRECTIONALITY_PARAGRAPH_SEPARATOR)
                | (1 << Character.DIRECTIONALITY_SEGMENT_SEPARATOR)) >> Character.getDirectionality(c)) & 1) != 0;
    }
