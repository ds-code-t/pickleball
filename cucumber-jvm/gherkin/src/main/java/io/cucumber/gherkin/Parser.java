 ...
 * href=http://https://github.com/gasparnagy/berp>Berp</a>.
 * <p>
...
final class Parser<T> {
    ...
    enum RuleType {
        ...
        Feature, // Feature! := FeatureHeader Background? ScenarioDefinition*
                 // Rule*
        FeatureHeader, // FeatureHeader! := #Language? Tags? #FeatureLine
                       // DescriptionHelper
        ...
        ScenarioDefinition, // ScenarioDefinition!
                            // [#Empty|#Comment|#TagLine->#ScenarioLine] :=
                            // Tags? Scenario
        Scenario, // Scenario! := #ScenarioLine DescriptionHelper Step*
                  // ExamplesDefinition*
        ExamplesDefinition, // ExamplesDefinition!
                            // [#Empty|#Comment|#TagLine->#ExamplesLine] :=
                            // Tags? Examples
        ...
        DocString, // DocString! := #DocStringSeparator #Other*
                   // #DocStringSeparator
        Tags, // Tags! := #TagLine+
    ...
    static final class ParserContext {
        ...
        ParserContext(
                TokenScanner tokenScanner, TokenMatcher tokenMatcher, Queue<Token> tokenQueue,
    ...
    private <V> void handleAstError(
            ParserContext context, V value, Builder<T> b, final BiConsumer<Builder<T>, V> action
    ) {
        try {
    ...
    private boolean handleExternalError(
            ParserContext context, Token token,
    ...
    private int matchTokenAt_3(Token token, ParserContext context) {
        ...
        List<String> expectedTokens = asList("#EOF", "#Empty", "#Comment", "#BackgroundLine", "#TagLine",
            "#ScenarioLine", "#RuleLine", "#Other");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    private int matchTokenAt_4(Token token, ParserContext context) {
        ...
        List<String> expectedTokens = asList("#EOF", "#Comment", "#BackgroundLine", "#TagLine", "#ScenarioLine",
            "#RuleLine", "#Other");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    private int matchTokenAt_5(Token token, ParserContext context) {
        ...
        List<String> expectedTokens = asList("#EOF", "#Empty", "#Comment", "#StepLine", "#TagLine", "#ScenarioLine",
            "#RuleLine", "#Other");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    private int matchTokenAt_6(Token token, ParserContext context) {
        ...
        List<String> expectedTokens = asList("#EOF", "#Comment", "#StepLine", "#TagLine", "#ScenarioLine", "#RuleLine",
            "#Other");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    private int matchTokenAt_7(Token token, ParserContext context) {
        ...
        List<String> expectedTokens = asList("#EOF", "#TableRow", "#DocStringSeparator", "#StepLine", "#TagLine",
            "#ScenarioLine", "#RuleLine", "#Comment", "#Empty");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    private int matchTokenAt_8(Token token, ParserContext context) {
        ...
        List<String> expectedTokens = asList("#EOF", "#TableRow", "#StepLine", "#TagLine", "#ScenarioLine", "#RuleLine",
            "#Comment", "#Empty");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    private int matchTokenAt_10(Token token, ParserContext context) {
        ...
        List<String> expectedTokens = asList("#EOF", "#Empty", "#Comment", "#StepLine", "#TagLine", "#ExamplesLine",
            "#ScenarioLine", "#RuleLine", "#Other");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    private int matchTokenAt_11(Token token, ParserContext context) {
        ...
        List<String> expectedTokens = asList("#EOF", "#Comment", "#StepLine", "#TagLine", "#ExamplesLine",
            "#ScenarioLine", "#RuleLine", "#Other");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    private int matchTokenAt_12(Token token, ParserContext context) {
        ...
        List<String> expectedTokens = asList("#EOF", "#TableRow", "#DocStringSeparator", "#StepLine", "#TagLine",
            "#ExamplesLine", "#ScenarioLine", "#RuleLine", "#Comment", "#Empty");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    private int matchTokenAt_13(Token token, ParserContext context) {
        ...
        List<String> expectedTokens = asList("#EOF", "#TableRow", "#StepLine", "#TagLine", "#ExamplesLine",
            "#ScenarioLine", "#RuleLine", "#Comment", "#Empty");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    private int matchTokenAt_15(Token token, ParserContext context) {
        ...
        List<String> expectedTokens = asList("#EOF", "#Empty", "#Comment", "#TableRow", "#TagLine", "#ExamplesLine",
            "#ScenarioLine", "#RuleLine", "#Other");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    private int matchTokenAt_16(Token token, ParserContext context) {
        ...
        List<String> expectedTokens = asList("#EOF", "#Comment", "#TableRow", "#TagLine", "#ExamplesLine",
            "#ScenarioLine", "#RuleLine", "#Other");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    private int matchTokenAt_17(Token token, ParserContext context) {
        ...
        List<String> expectedTokens = asList("#EOF", "#TableRow", "#TagLine", "#ExamplesLine", "#ScenarioLine",
            "#RuleLine", "#Comment", "#Empty");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    private int matchTokenAt_36(Token token, ParserContext context) {
        ...
        List<String> expectedTokens = asList("#EOF", "#StepLine", "#TagLine", "#ExamplesLine", "#ScenarioLine",
            "#RuleLine", "#Comment", "#Empty");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
    ...
    private int matchTokenAt_38(Token token, ParserContext context) {
        ...
        List<String> expectedTokens = asList("#EOF", "#StepLine", "#TagLine", "#ScenarioLine", "#RuleLine", "#Comment",
            "#Empty");
        ParserException error = token.isEOF()
                ? new ParserException.UnexpectedEOFException(token, expectedTokens, stateComment)
                : new ParserException.UnexpectedTokenException(token, expectedTokens, stateComment);
